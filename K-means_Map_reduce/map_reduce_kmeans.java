...
/*
En la clase Mapper que van a sustituir la función de configuración. 
En este estamos leyendo el archivo de caché distribuida y 
luego almacenar esto en instancia de variable "mCenters"
*/
	public static class Map extends MapReduceBase implements
		...
		/*
  		Función de Map se encuentra el centro del punto mínimo y emitirla al Reduce
		*/
		@Override
		public void map(LongWritable key, Text value,
			...
			double min1, min2 = Double.MAX_VALUE, nearest_center = mCenters
					.get(0);
			// Busca el centro minimo desdeun punto
			...
			// Emite el centro mas cercano y el punto
	...
	public static class Reduce extends MapReduceBase implements
		...
		/*
		La funcion Reduce emitirá todos los puntos a ese centro y calcular el próximo centro de estos puntos
		*/
		@Override
		public void reduce(DoubleWritable key, Iterator<DoubleWritable> values,
			...
			// Nosotros tenemos un nuevo centro ahora
			newCenter = sum / no_elements;

			// Emite nuevo centro y un punto
	...
	public static void run(String[] args) throws Exception {
		...
		// Reitera hasta que exista convergencia
		int iteration = 0;
		...
		while (isdone == false) {
			...
			if (iteration == 0) {
				...
				//Sube el archivo a hdfs. Sobreescribe cualquier anterior
			...
			/*
			Clasificar el viejo centro de gravedad y el nuevo centro de gravedad y comprobar la convergencia
				*/
