...
public class KMeans {
	...
	//Número de agrupaciones. Esta métrica debe estar relacionada con el número de puntos
	...
	//El proceso para calcular los Medios K, con el método de iteración.
    public void calculate() {
        boolean finish = false;
        int iteration = 0;
        
        // Añadir en nuevos datos, uno a la vez, el cálculo de centroides con cada uno nuevo.
        while(!finish) {
        	//Clear cluster state
        	clearClusters();
